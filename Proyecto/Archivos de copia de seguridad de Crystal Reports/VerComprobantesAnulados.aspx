<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerComprobantesAnulados.aspx.cs" Inherits="IU.VentasCuentasCobrar.Comprobantes.VerComprobantesAnulados" %>
        ...
        <ext:BorderLayout ID="BorderLayout1" runat="server">
            ...
            <Center MarginsSummary="0 5 0 5">
                ...
                Layout="Fit">
                    ...
                    <Buttons>                       
                        <ext:Button ID="btnVerComprobante" runat="server"  Text="Ver Comprobante" Icon="Image">
                            <DirectEvents>
                            <Click OnEvent="btnVerComprobante_OnClick" >
                            <ExtraParams>
...
<ext:Window 
            ...
            <Buttons>
                <ext:Button ID="Button1"
                    ...
                    runat="server">
                    <DirectEvents>
                        <Click OnEvent="WindowComprobanteAnulado_BotonImprimir_Click">
                            <ExtraParams>
                ...
                <ext:Button ID="Button2" 
                    ...
                    runat="server">
                    <DirectEvents>
                        <Click OnEvent="WindowComprobanteAnulado_BotonCancelar_Click" Before="#{FormPanel2}.getForm().reset();"></Click>
                    </DirectEvents>
                </ext:Button>
            </Buttons>
        </ext:Window>
