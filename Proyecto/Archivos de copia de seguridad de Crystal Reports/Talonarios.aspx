...
>
    ...
    <Reader>
        ...
        <Fields >
                  ...
                  <ext:RecordField  Name="fechaVencimiento"   Type="Date" DateFormat="dd/mm/yyyy"  ></ext:RecordField>
            ...
            <Center MarginsSummary="0 5 0 5">
                ...
                Layout="Fit">
                    ...
                    <ext:GridView ForceFit="true"  ScrollOffset="0"   ></ext:GridView>
                            ...
                            >
                            <Editor>
                            <ext:DateField AllowBlank="true" AutoDataBind="true" DataIndex="fechaVencimiento" runat="server" ></ext:DateField>
                            </Editor>
                            </ext:DateColumn>
