...
{
    public partial class ControlAbm : System.Web.UI.UserControl
    {
        private Type tipo;
        public Type Tipo
        {
...
#warning Por favor no comentar, dejar así para que después trabaje acá.
                if (false && (bool)Session["Respuesta"] == false)
                {
                    DoConfirm();
                }
                else
