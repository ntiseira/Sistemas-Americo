...
>
    ...
    <Reader>
        ...
        <Fields >
                  ...
                  <ext:RecordField  Name="fechaVencimiento"  Type="Auto" ></ext:RecordField>
            ...
            <Center MarginsSummary="0 5 0 5">
                ...
                Layout="Fit">
                    ...
                    <ext:GridView ForceFit="true"  ScrollOffset="0"   ></ext:GridView>
                            ...
                            <Columns>                            
                               <ext:Column  Align="Center" Header="Codigo" Editable="false" Resizable="true"   DataIndex="NroTalonario" >                                                         
                               <Editor>                                                  
                            ...
                            <ext:Column Header="Nro.Hasta" Editable="true" Resizable="true"  DataIndex="Hasta"  Align="Center">                                                        
                              <Editor>                                 
                               ...
                               <ext:DateColumn   ColumnID="ahora" Header="Fecha de Vencimiento" DataIndex="fechaVencimiento"  Align="Center"   Format="MM/dd/yyyy">                                                                    
                            <Editor>             
                            ...
                            <ext:Column Header="Tipo de comprobante" Editable="true" Resizable="true"  DataIndex="tiposcomprobante_idtipocomprobante"  Align="Center" >                                                        
                              <Editor>                                                           
                              <ext:ComboBox   runat="server"   DataIndex="Tiposcomprobante_idtipocomprobante" Text="codigo"></ext:ComboBox>                               
                              </Editor>                              
                            </ext:Column>  
