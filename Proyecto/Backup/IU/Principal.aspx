                                            ...
                                            <ext:Menu ID="Menu29" runat="server">
                                                <Items>                      
                                                    ...
                                                    <ext:MenuItem ID="MenuItem49" runat="server" Text="Lista de comprobantes" >      
                                                        <Listeners>
                                                            <Click Handler="addTab(#{TabPanel1}, 'Lista de comprobantes de venta', '/VentasCuentasCobrar/Comprobantes/PreparacionListadoVentas.aspx');" />
                                                        </Listeners>                           
                                                    </ext:MenuItem>                                                                                              
                                 ...
                                 <Items>
                                   ...
                                   <ext:MenuItem runat="server" Text="Dar Resumen de cuenta">
                                    ...
                                    <ext:MenuItem ID="MenuItem39" runat="server" Text="Ingreso de saldos y ajustes">
                                                        <Listeners> 
                                                            <Click Handler="addTab(#{TabPanel1}, 'Ingreso de saldos y ajustes', '/VentasCuentasCobrar/CuentaCorrienteyCobranzas/IngresoSaldoyAjustes.aspx');" />
                                                        </Listeners>                                                               
                                                    </ext:MenuItem>
                                                    </Items>
                                                    </ext:Menu>
                                        ...
                                        <ext:Menu ID="Menu11" runat="server">
                                            <Items>
                                                ...
                                                <ext:MenuItem ID="MenuItem59" runat="server" Text="Gestionar conceptos">
                                                    <Listeners>
                                                        <Click Handler="addTab(#{TabPanel1}, 'Conceptos de facturación', '/VentasCuentasCobrar/Concepto.aspx');" />
                                                    </Listeners>                                                  
                                                </ext:MenuItem>   
                                                    ...
                                                    <ext:Menu ID="Menu32" runat="server">
                                                        <Items>
                                                            <ext:MenuItem ID="MenuItem85" runat="server" Text="Libro Iva Ventas">
                                                                <Listeners>
                                                                    <Click Handler="addTab(#{TabPanel1}, 'Libro diario', '/VentasCuentasCobrar/LibroIvaVentas.aspx');" />
                                                                </Listeners>
                                                            </ext:MenuItem>
                                                        </Items>
                                                    </ext:Menu>
