                                        ...
                                        <ext:Menu ID="Menu11" runat="server">
                                            <Items>
                                                <ext:MenuItem ID="MenuItem38" runat="server" Text="Talonarios">
                                                    <Listeners>
                                                        <Click Handler="addTab(#{TabPanel1}, 'Talonarios', '/VentasCuentasCobrar/TalonarioGenerico.aspx');" />
                                                    </Listeners>
                                                </ext:MenuItem>
                                                <ext:MenuItem ID="MenuItem63" runat="server" Text="Causa de emisión">
                                                    <Listeners>
                                                        <Click Handler="addTab(#{TabPanel1}, 'Causas de emisión', '/VentasCuentasCobrar/CausaEmision.aspx');" />
                                                    </Listeners>
                                                </ext:MenuItem>
                                                ...
                                                <ext:MenuItem ID="MenuItem59" runat="server" Text="Gestionar conceptos">
                                                    <Listeners>
                                                        <Click Handler="addTab(#{TabPanel1}, 'Conceptos de facturación', '/VentasCuentasCobrar/ConceptoFact.aspx');" />
                                                    </Listeners>                                                  
                                                </ext:MenuItem>   
