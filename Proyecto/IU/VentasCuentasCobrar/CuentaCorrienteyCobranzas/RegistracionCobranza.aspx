<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistracionCobranza.aspx.cs" Inherits="IU.VentasCuentasCobrar.Cobranzas.RegistracionCobranza" %>
         ...
         Padding="1"
          Width="500"
           ...
           <ext:DateField
            ...
            <Buttons>
           <ext:Button ID="Button1" runat="server" Text="Registrar Cobranza">
               <DirectEvents>        
                    <Click OnEvent="BotonRegistrarCobranza">        
