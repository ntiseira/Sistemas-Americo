...
namespace IU.VentasCuentasCobrar.CuentaCorrienteyCobranzas
{
    public partial class GestionarCuentaCorriente : System.Web.UI.Page
    {
        ...
        private object SelectedCodigo;

        public object SelectedCodigoCliente
        {
            get { return Session["codigo_cliente"]; }
            set { Session["codigo_cliente"] = value; }
        }
        ...
        {               
            try
            {
                if (!X.IsAjaxRequest)
                {
                    SelectedCodigoCliente = 0;
                }

                this.ControlAbm1.MostrarBotones(true);
                ...
                { 
                    new SqlValor("cliente_codCliente", int.Parse(SelectedCodigoCliente.ToString())), 
        ...
        void ControlAbm1_AlSeleccionar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SelectedCodigoCliente = cli.Codcliente;
            }
