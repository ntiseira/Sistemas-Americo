...
using System.Net;
using IU.VentasCuentasCobrar.Reportes.DataSetFacturaTableAdapters;

using System.Web.Script.Serialization;
using IU.VentasCuentasCobrar.Reportes.DataSetLineaDeVentaTableAdapters;

namespace IU.VentasCuentasCobrar.Comprobantes
{
    public partial class VerComprobantesAnulados : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.Titulo = "Lista de Comprobantes Anulados";

                Valores = new SqlValor[] 
            { 
                new SqlValor("habilitado", 0),
        ...
        private void MostrarPdf(string rutaArchivo)
        {
