...
<script runat="server">
    ...
    protected void ComboBox1_Select(object sender, DirectEventArgs e)
    {
        ...
        cookie.Value = this.ComboClasesCliente.SelectedItem.Value;     
        this.Response.Cookies.Add(cookie);
        this.asignarSituacionIva(int.Parse(cookie.Value));   
    }


    protected void ComboBoxDescuentoComercial_Select(object sender, DirectEventArgs e)
    {
       
        this.SelectedDescuentoComercial =this.ComboBoxDescuentoComercial.SelectedItem.Value;

    }


    protected void ComboBoxDescuentoFinanciero_Select(object sender, DirectEventArgs e)
    {
        this.SelectedDescuentoFinanciero = this.ComboBoxDescuentoFinanciero.SelectedItem.Value;
    }
    ...
    protected void CheckBoxDecuentoFinanciero_Select(object sender, DirectEventArgs e)
    {
 
        this.CheckBoxDescuentoFinanciero = true;
        SelectedDescuentoFinanciero = ComboBoxDescuentoFinanciero.SelectedItem.Value;
      
    }

    protected void CheckBoxDecuentoComercial_Select(object sender, DirectEventArgs e)
    {
        this.CheckBoxDescuentoComercial = true;
        SelectedDescuentoComercial =  ComboBoxDescuentoComercial.SelectedItem.Value;
...
<script language="javascript" type="text/javascript">
    ...
    var ChangeValue = function (value) {
        ...
        var comboBox = value;
        var valueCombo = comboBox.getValue();
...
>
                            ...
                            <ext:TabPanel ID="TabPanel1" runat="server">   
                                <Items>
                                    ...
                                    <ext:Panel ID="Tab1" runat="server" 
                                      ...
                                      <ext:CompositeField 
                                      ID="CompositeDescuentoComercial"
                                       runat="server"
                                        FieldLabel="Descuento Comercial" AnchorHorizontal="100%">
                                                            
                                           <Items>  
                                                <ext:Checkbox ID="CheckboxDescuentoComercial" runat="server" 
                                                   Enabled="false"
                                                    FieldLabel="Descuento comercial"
                                                     OnDirectCheck="CheckBoxDecuentoComercial_Select"
                                                    >
                                                ...
                                                <ext:ComboBox 
                                                  ...
                                                  DataIndex="Iddescuentoscomerciales"                  
                                                   OnDirectSelect="ComboBoxDescuentoComercial_Select"
                                                >
                                            ...
                                            <Items>
                                             ...
                                             <ext:CompositeField 
                                      ID="CompositeDescuentoFinanciero"
                                       runat="server"
                                        FieldLabel="Descuento Financiero" AnchorHorizontal="100%">
                                        ...
                                        <Items>
                                                ...
                                                <ext:Checkbox ID="CheckboxDescuentoFinanciero" runat="server" 
                                                    ...
                                                    FieldLabel="Descuento financiero"
                                                     OnDirectCheck="CheckBoxDecuentoFinanciero_Select"
                                                    >
                                                </ext:Checkbox>
                                            ...
                                            DataIndex="Iddescuentosfinancieros"
                                             OnDirectSelect="ComboBoxDescuentoFinanciero_Select"
                                        >                                      
                                          ...
                                          <ext:TextField ID="RegimenEspecial" runat="server"  FieldLabel="Regimen especial aplicado" Hidden="true">
                                          </ext:TextField>
                        ...
                        <Items>
                            <ext:ColumnLayout ID="ColumnLayout1" runat="server" Split="false" FitHeight="true">
                                <Columns>
                                    ...
                                    <ext:LayoutColumn ColumnWidth="0.10">
                                        <ext:Panel ID="Panel18" runat="server" Title="Subtotal">
                                            <Items>
                                                <ext:TextField ID="Subtotal" runat="server" ReadOnly="true" >
                                                </ext:TextField>
                                            </Items>
                                        </ext:Panel>
                                    </ext:LayoutColumn>
                                    ...
                                    <ext:LayoutColumn ColumnWidth="0.26">
                                        <ext:Panel 
                                            ...
                                            <Items>  
                                                ...
                                                <ext:Button ID="BotonRegimenEsp" Text="Regímenes Especiales" Enabled="false" runat="server" Hidden="true">
                                                <DirectEvents>
    ...
    <ext:Window 
     ...
     <ext:Window 
           ...
           <ext:CompositeField ID="CompositeField1" runat="server" FieldLabel="Fecha" AnchorHorizontal="100%">
                <Items>           
                     ...
                     <ext:DateField  
                        ...
                        >
                         ...
                         <ext:DisplayField ID="DisplayField1" runat="server" Text="Tarjeta" />
                           <ext:ComboBox 
            ...
            <ext:CompositeField ID="CompositeField2" runat="server" FieldLabel="N° estable" AnchorHorizontal="100%">
                <Items>
         ...
         <ext:DisplayField ID="DisplayField2" runat="server" Text="Telefono Autorizado" />                                        
                                 <ext:NumberField 
            ...
            <ext:CompositeField ID="CompositeField3" runat="server" FieldLabel="Tarjeta a nombre de" AnchorHorizontal="100%">
                <Items>
                    ...
                    <ext:DisplayField ID="DisplayField3" runat="server" Text="Numero de tarjeta" />    
                                         <ext:NumberField 
                                    ID="NumeroTarjeta"
                                    runat="server"
            ...
            <ext:CompositeField ID="CompositeField4" runat="server" FieldLabel="Vencimiento" AnchorHorizontal="100%">
                <Items>
                  <ext:DateField  
                                    ID="VencimienotCupon"
                                    runat="server" 
        ...
        <ext:DisplayField ID="DisplayField4" runat="server" Text="Cantidad de Cuotas" />    
                                    <ext:NumberField 
                                    ID="CantCuotas"
                                    runat="server"
            ...
            <ext:CompositeField ID="CompositeField5" runat="server" FieldLabel="Codigo de Autorizacion">
                <Items>
                         <ext:NumberField 
                                    ID="CodAutorizado"
                                    runat="server"
                       ...
                       <ext:DisplayField ID="DisplayField5" runat="server" Text="Telefono" />                  
                                      <ext:NumberField 
                                    ID="TelefonoTarjeta"
                                    runat="server"
                                    FieldLabel="Telefono"
                                   AnchorHorizontal="100%"                                                                                                         
                                    Selectable="true"                                    
                                     >
                                      ...
                                      <ext:CompositeField ID="CompositeField6" runat="server" FieldLabel="Dni">
                <Items>
                  ...
                  <ext:DisplayField ID="DisplayField6" runat="server" Text="Cuenta corriente del cliente" />      
                            <ext:ComboBox 
              ...
              <ext:CompositeField ID="CompositeField7" runat="server" FieldLabel="Concepto">
                <Items>
                      <ext:TextField 
                        ID="ConceptoTarjeta" 
                        runat="server" 
                    ...
                    <ext:DisplayField ID="DisplayField7" runat="server" Text="Importe" />                                          
                        <ext:NumberField 
                        ID="ImporteTarjeta"
                        runat="server"
                        FieldLabel="Importe"
