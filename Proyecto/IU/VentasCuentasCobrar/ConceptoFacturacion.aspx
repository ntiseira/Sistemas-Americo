<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConceptoFacturacion.aspx.cs" Inherits="IU.VentasCuentasCobrar.ConceptoFacturacion" %>
                ...
                Layout="Fit">
                    ...
                    <ext:GridView ForceFit="true"  ScrollOffset="0"   ></ext:GridView>
                            ...
                            <ext:Column  Align="Center" Header="Clase" Editable="true" Resizable="true"  DataIndex="Clase"   >                                                        
                              ...
                              <ext:Column Align="Center" Header="Tasa Iva" Editable="true" Resizable="true"  DataIndex="Tasaiva"  
                                     >                                                        
                              <Editor>                             
                             ...
                             >                                      
                               ...
                               <ext:Column   ColumnID="precio"  Align="Center" Header="Precio Neto" Editable="true" Resizable="true"  DataIndex="PrecioNeto"   >                                                        
                                  ...
                                  <Editor>       
                                <ext:TextField  ID="precioField" DataIndex="precioNeto" runat="server"  Name="precio"  Text="precioNeto"   >
                                 <DirectEvents>
                                  <Change   OnEvent="OnRowSelect">
                                    <ExtraParams>
                            ...
                            <ext:Column Header="Moneda" Editable="true" Resizable="true"  DataIndex="Moneda_idmoneda"  Align="Center" >                                                        
                              <Editor>                                                           
                              <ext:ComboBox ID="ComboBox1"  StoreID="StoreComboMonedas" ValueField="Idmoneda" DisplayField="Moneda"  runat="server" Text="codigo"></ext:ComboBox>                               
                              </Editor>                              
                            </ext:Column>  
