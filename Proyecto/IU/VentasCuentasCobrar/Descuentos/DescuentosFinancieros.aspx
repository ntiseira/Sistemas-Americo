<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescuentosFinancieros.aspx.cs" Inherits="IU.VentasCuentasCobrar.Descuentos.DescuentosFinancieros" %>
...
>
    ...
    <Reader>
        <ext:JsonReader>
        <Fields >
        <ext:RecordField  Name="iddescuentosfinancieros" Type="Auto"   ></ext:RecordField>
        <ext:RecordField  Name="descripcion" Type="Auto" ></ext:RecordField>
         <ext:RecordField  Name="descuento"  Type="Auto"></ext:RecordField>
          <ext:RecordField  Name="porcentaje"  Type="Auto"></ext:RecordField>
                ...
                Layout="Fit">
                    <Items>                       
                        ...
                        >
                            ...
                            <Columns>                         
                            <ext:Column   Align="Center" Header="Codigo" Editable="false" Resizable="true"   DataIndex="Iddescuentosfinancieros" >                                                         
                                <Editor>                                                  
                                    <ext:TextField ID="TextField1"  DataIndex="iddescuentosfinancieros" runat="server" Visible="true"       ></ext:TextField>
                                </Editor>                                
                            </ext:Column>                            
                            <ext:Column Align="Center"  Width="300" Header="Descripcion"  Sortable="true" Editable="true" Resizable="true"  DataIndex="Descripcion"    >   
                              <Editor>                         
                                <ext:TextField ID="TextField2"  DataIndex="descripcion" runat="server"    Text="Descripcion" Visible="true"   AllowBlank="false" > </ext:TextField>
                              </Editor>                                                     
                            </ext:Column>                            
                            
                             <ext:CheckColumn Header="descuento" Editable="true" Resizable="true" DataIndex="Descuento" Align="Center">
                             <Editor>  
                              <ext:Checkbox ID="Checkbox1" runat="server" DataIndex="descuento" >
                             </ext:Checkbox>                                    
                              </Editor>
                            </ext:CheckColumn>  
                            
                            <ext:Column  Align="Center" Header="Porcentaje" Editable="true" Resizable="true"  DataIndex="Porcentaje"  >                                                        
                              <Editor>  
                             <ext:NumberField 
                             runat="server" 
