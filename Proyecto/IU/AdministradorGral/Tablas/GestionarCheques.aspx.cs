...
{
    public partial class GestionarCheques : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!X.IsAjaxRequest)
            {
                Session["GestionarPropios_Indice_idindice"] = 0;
            }
        ...
        void ControlAbm1_AlSeleccionar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["GestionarPropios_Indice_idindice"] = indx.Idcheque;
            }
